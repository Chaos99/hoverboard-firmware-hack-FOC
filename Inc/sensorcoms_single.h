...
#if defined (SENSOR_SERIAL_USART3)
...
typedef struct tag_sensor_data{
  ...
  int bytecount;
  int framecopied;
  SENSOR_FRAME complete; // the actual sensor data
  ...
  unsigned int foottime_ms; // last time we transitioned this foot.
